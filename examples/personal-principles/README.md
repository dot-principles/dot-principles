...
An example extra-catalog for the [`.principles`](https://github.com/dot-principles/dot-principles.github.io) system, demonstrating how to extend the built-in catalog with your own principles - without forking.
...
Used with `install.sh` via [`--extra-catalog`](https://github.com/dot-principles/dot-principles.github.io/blob/main/INSTALL.md#9-corporate--personal-principles) - no fork needed.
...
3. Follow the [extra-catalog template](https://github.com/dot-principles/dot-principles.github.io/tree/main/templates/extra-catalog) for structure conventions
4. Register it via `~/.principles-extra` or `--extra-catalog`

See [INSTALL.md §9 - Corporate & Personal Principles](https://github.com/dot-principles/dot-principles.github.io/blob/main/INSTALL.md#9-corporate--personal-principles) for the full guide.
