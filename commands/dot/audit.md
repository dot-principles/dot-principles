...
> - read `{{PRINCIPLES_DIRECTORY}}/active.md`; keep if it contains the generated-by marker (`<!-- generated by /dot-scout`)
> - if absent: glob `.github/instructions/*.instructions.md` and `REVIEW.md` (at the git root) — Copilot Code Review and Claude Code Review outputs; keep only files containing the generated-by marker
...
1. Read `{{PRINCIPLES_DIRECTORY}}/active.md`; check for the `<!-- generated by /dot-scout` marker
