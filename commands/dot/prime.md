...
> 1. Glob `.github/instructions/*.instructions.md` and `REVIEW.md` (at the git root); keep only files containing a generated-by marker (`<!-- generated by /dot-scout` or legacy `<!-- generated by /scout`). If any are found, continue.
...
2. Glob `REVIEW.md` at the git root
...
> These are your focus principles for this task. Any full rule set from `REVIEW.md` or `.github/instructions/` remains active. Proceed.
