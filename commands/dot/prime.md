...
> 1. Read `{{PRINCIPLES_DIRECTORY}}/active.md`; keep if it contains the generated-by marker (`<!-- generated by /dot-scout`). If found, continue.
...
1. **`{{PRINCIPLES_DIRECTORY}}/active.md`** — written by `/dot-scout` Phase 6 on every run; present whenever the catalog is vendored. Check for the `<!-- generated by /dot-scout` marker.
