...
>
> If **no explicit spec** is present, check whether scout-generated files exist from a previous `/dot-scout` run:
> - glob `.github/instructions/*.instructions.md` and `.claude/rules/*.md`
> - keep only files containing a generated-by marker (`<!-- generated by /dot-scout` or legacy `<!-- generated by /scout`)
> - if none are found → **STOP. Do not proceed. Respond only with:**
>
